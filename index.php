...
<head>
    ...
    <title>Welcome to Shakuntala Foundation</title>

    <meta name="description"
        content="Shakuntala Foundation is committed to transforming lives by providing education, shelter, and healthcare to those who need it most. Join us in our mission to create a compassionate and inclusive society where everyone has the opportunity to thrive. Explore our initiatives and learn how you can make a difference today.">
...
<body>
    ...
    <!-- Start Solve Area -->
    <section class="solve-section pb-30">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="solve-area-content">
                        ...
                        <h3>When Ambition Meets Opportunity Everything is to be Possible in all</h3>
                        <p>Our possibilities wansis dolor sit amet, consectetur adipiscing elised do eiusmod tempor incididunt ut labore et dolore magna aliquaenimminim veniam, quis nostrud exercitatio.</p>
    ...
    <!-- Start Country Area -->
    <section class="country-section ptb-100">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="country-area-content">
                        ...
                        <p>We are working wansis dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                    </div>
    ...
    <!-- Start Causes Area -->
    <section class="causes-section pb-70">
        <div class="container">
    ...
    <!-- Start Process Area -->
    <section class="process-section center-process pb-30">
        <div class="container">
            <div class="section-title">
                <span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="process-item">
                        ...
                        <a href="contact.html" class="process-btn">Give Requist +</a>
                    </div>
                    ...
                    <div class="process-item">
                        ...
                        <a href="contact.html" class="process-btn">Get Reaction +</a>
                    </div>
                    ...
                    <div class="process-item">
                        ...
                        <h3>Get Enjoyed</h3>
                        <p>Lorem ipsum dolor siamet ecteturadipisicing</p>
                        <a href="contact.html" class="process-btn">Enjoy Now +</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="donate-form-section pb-100 pt-200">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
    ...
    <!-- Start Events Area -->
    <section class="event-area pb-100">
        <div class="container-fluid">
            <div class="section-title">
                <span>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 p-0">
                    <div class="event-area-content">
                        ...
                        <div class="content">
                            ...
                            <h3>Huruma Con Donation for poor child 2024</h3>
                            ...
                            <a href="team.html" class="event-btn-one">Join now +</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 p-0">
                    <div class="event-area-content">
                        ...
                        <div class="content">
                            ...
                            <h3>Poor funding for helpless in africa</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod te incididunt ut labore et dolore magna aliqua.</p>
                            <a href="team.html" class="event-btn-one">Join now +</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 p-0">
                    <div class="event-area-content">
                        <div class="event-image">
                        ...
                        <div class="content">
                            ...
                            <h3>Education is necessary to poverty family in Canada</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod te incididunt ut labore et dolore magna aliqua.</p>
                            <a href="team.html" class="event-btn-one">Join now +</a>
                        </div>
                    </div>
    ...
    <section class="testimonials-section pb-30">
        <div class="container">
            <div class="section-title">
                <span>
    ...
    <!-- Start Donate Area -->
    <section class="donate-section pb-100 pt-200">
        <div class="container">
            <div class="section-title">
                ...
                <a href="team.html" class="donate-btn">
                    Become A Volunteer
                    <i class="flaticon-right"></i>
                </a>
            </div>
